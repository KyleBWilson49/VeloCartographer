...
var GoogleApiUtil = require('../../util/google_api')
var DirectionStore = require('../../stores/directions')
var OldRouteStore = require('../../stores/oldRoute')
...
var CreateRouteMap = React.createClass({
  ...
  showOldRoute: function () {
    ...
    var oldRoute = JSON.parse(OldRouteStore.route().route_path)
